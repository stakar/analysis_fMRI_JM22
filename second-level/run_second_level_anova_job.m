%-----------------------------------------------------------------------
% Job saved on 11-Mar-2024 12:20:04 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.factorial_design.dir = {'E:\SPM_test\results_2ndLvl\ANOVA2x2_crit_ls_sus'};
matlabbatch{1}.spm.stats.factorial_design.des.fd.fact(1).name = 'time';
...
matlabbatch{1}.spm.stats.factorial_design.des.fd.fact(2).name = 'group';
