%-----------------------------------------------------------------------
% Job saved on 17-Apr-2024 20:01:57 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{3}.spm.stats.con.consess{3}.fcon.name = '<UNDEFINED>';
matlabbatch{3}.spm.stats.con.consess{3}.fcon.weights = '<UNDEFINED>';
