...
resdir = fullfile(pwd, '../../results_2ndLvl/ImRsOnly/'); % output location
...
for meta_n=1:numel(metainputs_name)
    for n_ses = 1:3
        ...
        for crun = 1:nrun
            ...
            inputs{2, crun} = cellstr(strcat('E:\SPM_test\results\', IMRS, '\stories-model\',contrast1,'.nii,1')); % Factorial design specification: Scans - cfg_files
