...
%     inputs{3, crun} = {fullfile(triggdir, sub,'ses-2', [sub, '_ses-2_Run1.mat'])}; % fMRI model specification: Multiple conditions - cfg_files
...
%     inputs{6, crun} = {fullfile(triggdir, sub,'ses-2', [sub, '_ses-2_Run2.mat'])}; % fMRI model specification: Multiple conditions - cfg_files
