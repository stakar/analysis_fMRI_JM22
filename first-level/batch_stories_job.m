...
% matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'SEMO > SCON';
% matlabbatch{3}.spm.stats.con.consess{4}.tcon.weights = [1 -1 0];
% matlabbatch{3}.spm.stats.con.consess{4}.tcon.sessrep = 'repl';
% matlabbatch{3}.spm.stats.con.consess{5}.tcon.name = 'SCON > SEMO';
