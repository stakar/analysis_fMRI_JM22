...
datadir = fullfile(pwd, 'spm12_test/'); % fmriprep dataset location
confounddir = fullfile(pwd, 'spm12_test/results/');
resdir = fullfile(pwd, 'results2/'); % output location
...
for crun = 1:nrun
    ...
    inputs{3, crun} = {fullfile(basedir, 'triggers', sub,'ses-1', [sub, '_ses-1_Run1.mat'])}; % fMRI model specification: Multiple conditions - cfg_files
    ...
    inputs{6, crun} = {fullfile(basedir, 'triggers', sub,'ses-1', [sub, '_ses-1_Run2.mat'])}; % fMRI model specification: Multiple conditions - cfg_files
    ...
    inputs{9, crun} = {fullfile(basedir, 'triggers', sub,'ses-2', [sub, '_ses-2_Run1.mat'])}; % fMRI model specification: Multiple conditions - cfg_files
    ...
    inputs{12, crun} = {fullfile(basedir, 'triggers', sub,'ses-2', [sub, '_ses-2_Run2.mat'])}; % fMRI model specification: Multiple conditions - cfg_files
